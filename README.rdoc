...
build apps in Mirah, with conventions familiar to Rails and Sinatra developers. 
...
===Creating a new Dubious Application

    dubious init app-name
...
If you are using jruby's rake, the task will watch for source file changes and update the running class files. Otherwise, you need to restart the server when you have changes.
