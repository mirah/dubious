...
Now git clone bitescript, mirah and dubious to your drive
   ...
   git clone http://github.com/takeru/dubious
...
When you create a new Mirah file, you needs to add it the the build script
Run the build script whenever you modify a Mirah or ERb file. 
